        ...
        <div class="container">
          <form action="checkLogin.php" method="POST">
            <div class="container">
              ...
              <?php
              if (isset($_GET['err'])) {
                echo "<div class='alert alert-danger' role='alert' style='text-align:center;'>" . $_GET['err'] . " !</div>";
              }
              ?>
              ...
              <input type="password" placeholder="Enter Password" name="pws" id="pws" required>
            ...
            <div class="container signin">
              <p>Don't have an account? <a style="color:#fbab45"  href="Registration.php">Register</a></p>
            </div>
          </form>
        </div>
      </body>
