...
<div class="bgded overlay" style="background-image:url('back.jpg');"> 
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
        <header class="heading underline font-x2">Validate Movies</header>
          <ul class="nospace clear">
              <?php 
                require "pages/db-config.php";
                $con = mysqli_connect(DBHOST, DBUSER, DBPWD, DBNAME);
                $query = 'SELECT * FROM movie WHERE isvalidated = 0'; //You don't need a ; like you do in SQL
                  ...
                  if(($first % 4) == 0){ ?>
                      <li class="one_quarter first">
                          <div class="container0">
                              <img src="<?php echo $row['poster'] ?>" class="image" alt="poster">
                              <div class="middle">
                                  <a href="javascript:void(0)" class="see-more">
                                      <form action="MovieScreenAdmin.php" method="post">
