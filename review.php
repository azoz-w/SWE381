...
<div class="bgded overlay" style="background-image:url('back.jpg');"> 
  ...
  <div id="pageintro" class="hoc clear"> 
      ...
      <img src="google.png" style="position: absolute; top: 220px "> 
      <p style="position: absolute; left: 380px; top:260px; font-size: 30px">Title: ZZZZXXXX</p>
      <p style="position: absolute; left: 380px; top:330px; font-size: 30px">Rating: <span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span></p>
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<h2 style="text-align: center; position: absolute;  top: 500px">All reviews</h2>
<p style=" position: absolute;  top: 550px">Username, date         <br> <span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span>                                               </p>
<textarea rows="4" cols="110" style=" position: absolute;  top: 620px; color: black"></textarea>

<p style=" position: absolute;  top: 730px">Username, date         <br> <span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span>                                               </p>
<textarea rows="4" cols="110" style=" position: absolute;  top: 800px; color: black"></textarea>
