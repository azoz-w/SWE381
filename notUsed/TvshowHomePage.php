    ...
    <header id="header" class="hoc clear">
      ...
      <nav id="mainav" class="fl_right"> 
        <ul class="clear">
          ...
          <li><a href="add.html">add Tv show</a></li>
  ...
  <div id="pageintro" class="hoc clear"> 
    <article>
      ...
      <footer>
      	...
      	<table style="
      	border: 2px;
      	" class="nospace inline pushright">

      	<tr>
      		
      		<td ><a class="btn" href="https://www.google.com.sa" type="_blank"><img src="google.png"></a></td>
      		<td ><a class="btn" href="https://www.google.com.sa" type="_blank"><img src="google.png"></a></td>
      		<td ><a class="btn" href="https://www.google.com.sa" type="_blank"><img src="google.png"></a></td>
      	</tr>
      	<tr>
      	...
      	<a href="allMovies.html"><h6>All</h6></a>
      </footer>
    </article>
    <article>
    	<h1>movies</h1>
