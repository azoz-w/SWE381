...
<div class="bgded overlay" style="background-image:url('back.jpg');"> 
    ...
    <div id="topbar" class="hoc clear">
      ...
      <div class="fl_right"> 
        ...
        <ul class="nospace">
          ...
          <li id="searchform">
          <div>
              <form action="searchMoives.php" method="get">
                <fieldset>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
        <header class="heading underline font-x2">Search Results</header>
          <ul class="nospace clear">
              <?php 
                require "pages/db-config.php";
                $con = mysqli_connect(DBHOST, DBUSER, DBPWD, DBNAME);
                $title=$_GET["term"];
                $query = "SELECT * FROM movie WHERE isvalidated = 1 AND title like '%$title%'"; //You don't need a ; like you do in SQL
