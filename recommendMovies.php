...
<div class="bgded overlay" style="background-image:url('back.jpg');"> 
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
        <header class="heading underline font-x2">Recommended Movies</header>
             <ul class="nospace clear">
              <?php 
                $name = $_SESSION['login'];
                require "pages/db-config.php";
                $con = mysqli_connect(DBHOST, DBUSER, DBPWD, DBNAME);
                $query = "SELECT * FROM movie WHERE isvalidated = 1 AND title NOT IN(SELECT title FROM review WHERE usern ='" . $name . "') "; //You don't need a ; like you do in SQL
